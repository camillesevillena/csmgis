...
$getAdmin = mysqli_query($conn, "SELECT * FROM admin WHERE username = '$SESSION_USERNAME'") or die(mysqli_error($conn));
$DATA = mysqli_fetch_assoc($getAdmin);
// $teacherID = $DATA['id'];
if ($SESSION_USERNAME == "") {
    echo ("<script>window.location = '../admin-provincial-login.php';</script>");
} 
?>


<nav class="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top">
 <a class="navbar-brand" href="municipality-account.php" style="margin-left: 15%;">
